...
mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.airshard", "botania.entry.prismarine", 7, [airShard], [[[prismarineShard, yellowFlower]]]);
game.setLocalization("en_US", "botania.page.prismarine.airshard", "Crafting an &1Air Shard&0");
recipes.addShapeless(airShard, [prismarineShard, yellowFlower]);

mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.fireshard", "botania.entry.prismarine", 8, [fireShard], [[[prismarineShard, redFlower]]]);
game.setLocalization("en_US", "botania.page.prismarine.fireshard", "Crafting a &1Fire Shard&0");
recipes.addShapeless(fireShard, [prismarineShard, redFlower]);
mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.fireshard", "botania.entry.prismarine", 9, [fireShard], [[[prismarineShard, orangeFlower]]]);
recipes.addShapeless(fireShard, [prismarineShard, orangeFlower]);

mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.watershard", "botania.entry.prismarine", 10, [waterShard], [[[prismarineShard, lightBlueFlower]]]);
game.setLocalization("en_US", "botania.page.prismarine.watershard", "Crafting a &1Water Shard&0");
recipes.addShapeless(waterShard, [prismarineShard, lightBlueFlower]);
mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.watershard", "botania.entry.prismarine", 11, [waterShard], [[[prismarineShard, blueFlower]]]);
recipes.addShapeless(waterShard, [prismarineShard, blueFlower]);
mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.watershard", "botania.entry.prismarine", 12, [waterShard], [[[prismarineShard, cyanFlower]]]);
recipes.addShapeless(waterShard, [prismarineShard, cyanFlower]);

mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.earthshard", "botania.entry.prismarine", 13, [earthShard], [[[prismarineShard, greenFlower]]]);
game.setLocalization("en_US", "botania.page.prismarine.earthshard", "Crafting an &1Earth Shard&0");
recipes.addShapeless(earthShard, [prismarineShard, greenFlower]);
mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.earthshard", "botania.entry.prismarine", 14, [earthShard], [[[prismarineShard, limeFlower]]]);
recipes.addShapeless(earthShard, [prismarineShard, limeFlower]);

mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.ordershard", "botania.entry.prismarine", 15, [orderShard], [[[prismarineShard, pinkFlower]]]);
game.setLocalization("en_US", "botania.page.prismarine.ordershard", "Crafting an &1Order Shard&0");
recipes.addShapeless(orderShard, [prismarineShard, pinkFlower]);
mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.ordershard", "botania.entry.prismarine", 16, [orderShard], [[[prismarineShard, magentaFlower]]]);
recipes.addShapeless(orderShard, [prismarineShard, magentaFlower]);
mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.ordershard", "botania.entry.prismarine", 17, [orderShard], [[[prismarineShard, purpleFlower]]]);
recipes.addShapeless(orderShard, [prismarineShard, purpleFlower]);

mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.entropyshard", "botania.entry.prismarine", 18, [entropyShard], [[[prismarineShard, grayFlower]]]);
game.setLocalization("en_US", "botania.page.prismarine.entropyshard", "Crafting an &1Entropy Shard&0");
recipes.addShapeless(entropyShard, [prismarineShard, grayFlower]);
mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.entropyshard", "botania.entry.prismarine", 19, [entropyShard], [[[prismarineShard, lightGrayFlower]]]);
recipes.addShapeless(entropyShard, [prismarineShard, lightGrayFlower]);
mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.entropyshard", "botania.entry.prismarine", 20, [entropyShard], [[[prismarineShard, blackFlower]]]);
recipes.addShapeless(entropyShard, [prismarineShard, blackFlower]);

mods.botania.Lexicon.addCraftingPage("botania.page.prismarine.balancedshard", "botania.entry.prismarine", 21, [balancedShard], [[[prismarineShard, glimmeringWhiteFlower, salisMundus]]]);
game.setLocalization("en_US", "botania.page.prismarine.balancedshard", "Crafting a &1Balanced Shard&0 at the &oArcane Worktable&r");
...
mods.thaumcraft.Research.addArcanePage("CRUCIBLE", balancedShard * 2);
game.setLocalization("en_US", "tc.research_page.CRUCIBLE.6", "Botanical Balanced Vis Shards<BR><BR>Using botanical flowers to create Balanced Shards.");
...
mods.thaumcraft.Research.addResearch("SYMBIOTICBOTANIA", "BASICS", "terra 1, ordo 1", 0, -1, 0, <Botania:lexicon>);
...
mods.thaumcraft.Research.addCraftingPage("SYMBIOTICBOTANIA", airShard);
mods.thaumcraft.Research.addCraftingPage("SYMBIOTICBOTANIA", fireShard);
mods.thaumcraft.Research.addCraftingPage("SYMBIOTICBOTANIA", waterShard);
mods.thaumcraft.Research.addCraftingPage("SYMBIOTICBOTANIA", earthShard);
mods.thaumcraft.Research.addCraftingPage("SYMBIOTICBOTANIA", orderShard);
mods.thaumcraft.Research.addCraftingPage("SYMBIOTICBOTANIA", entropyShard);
...
mods.thaumcraft.Research.addResearch("SYMBIOTICBOTANIAINFUSION", "ARTIFICE", "terra 1, herba 1, arbor 1, praecantatio 1", -4, 6, 8, manaPylon);
...
game.setLocalization("en_US", "tc.research_page.ARCANESTONE.1", "Arcane stone is a basic building material for many complex mystical constructs. It is normal stone that has been seared by elemental fire and strengthened by elemental earth.<BR>Not any stone will do, however. Normal stone first needs to be metamorphized by Botania's Marimorphosis flower before it can become arcane stone.<BR>So meta.");
//The default text said: "Arcane stone is a basic building material for many complex mystical constructs. It is normal stone that has been seared by elemental fire and strengthened by elemental earth."
